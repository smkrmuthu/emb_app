...
export const SAMPLE_BILLS: BillData[] = [
...

  {
    ...
    dueDate: '13/07/2026',
    totalAmount: 1314,
    summaryPlain: 'TANGEDCO Tax Invoice (Month of June 2026) for DINESH.R (SITHALAPAKKAM). 910 units consumed. High slab warning: 410 units over the 500 threshold. Energy charges ₹4,691.50 less Govt Subsidy -₹1,824.75 and Adjustments -₹1,553.00 = Net Payable ₹1,314.00.',
    ebDetails: {
      state: 'tamil_nadu',
      ...
      nextSlabThreshold: {
        ...
        tip: 'Staying under 500 units next cycle keeps you out of the top ₹8.40 slab — saves ~₹3,444 across the 60-day cycle.'
      }
    },
    lineItems: [
